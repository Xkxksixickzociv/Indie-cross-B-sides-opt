...
function onCreate()
    if songName == 'Snake-Eyes' or songName == 'Knockout' or songName == 'Technicolor-Tussle' or songName == 'Devils-Gambit' or songName == 'Satanic-Funkin' or songName == 'wallop' then
    ...
    elseif songName == 'imminent-demise' or songName == 'Terrible-Sin' or songName == 'last-reel' or songName == 'Nightmare-Run' or songName == 'Ritual' or songName == 'Despair' then
    ...
    elseif songName == 'last-reel' then
        makeLuaSprite('TextIntro','bendy/introductionsong3',380,300)
        scaleEffect = 0.8;
